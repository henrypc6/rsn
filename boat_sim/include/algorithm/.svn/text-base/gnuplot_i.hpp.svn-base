...
class Gnuplot
{
	...
	//Complete bypasses the file creation
	//Directly plots a white line using command lines in gnuplot
	inline Gnuplot& simple_plot(string range)	{

	cmd("set xrange [-"+ range +":"+ range +"]");
	cmd("set yrange [-"+ range +":"+ range +"]");
	cmd("plot 0 with lines linecolor rgb \"white\" ");
